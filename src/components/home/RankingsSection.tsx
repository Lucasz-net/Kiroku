...
const SkeletonRow = () => (
  <div className="flex bg-[var(--kr-surface-sunken)] rounded-xl border border-[#FF3B3B]/[0.07] overflow-hidden animate-pulse">
    ...
    <div className="w-24 md:w-28 h-32 md:h-36 bg-[var(--kr-surface-2)] shrink-0" />
...
export const RankingsSection = ({ topRated, topPopular, topRatedError, topPopularError, onRetry }: RankingsSectionProps) => (
  <section className="rankings-section reveal-section relative z-30 bg-[var(--kr-surface-sunken)] -mt-[120px] pt-24 pb-32 px-4">
    ...
    <div className="section-content container mx-auto max-w-[1400px]">
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        {/* ── Top 10 Animes ── */}
        <div className="ranking-card-left bg-[var(--kr-surface)] border border-[#FF3B3B]/10 rounded-2xl p-6 relative">
          ...
          <h2 className="ranking-title text-2xl md:text-3xl font-black text-[var(--kr-text)] mb-6 tracking-tight">
            Top 10 Animes
          </h2>
          ...
          <div className="mt-6 pt-6 border-t border-[#FF3B3B]/10 flex justify-center">
            <Link
              to="/top/rated"
              className="px-6 py-2.5 border border-[#FF3B3B]/20 bg-[var(--kr-surface-sunken)] text-zinc-400 font-bold uppercase tracking-widest text-[11px] hover:bg-[#FF3B3B] hover:text-[var(--kr-text)] hover:border-[#FF3B3B] transition-all rounded-xl"
            >
              Ranking Completo
            </Link>
          </div>
        ...
        {/* ── Más Populares ── */}
        <div className="ranking-card-right bg-[var(--kr-surface)] border border-[#FF3B3B]/10 rounded-2xl p-6 relative">
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#FF3B3B]/20 to-transparent" />

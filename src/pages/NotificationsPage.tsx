    ...
    <div className="min-h-screen bg-[var(--kr-bg)] font-sans pt-28 md:pt-32 pb-24">
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-[var(--kr-text)] tracking-tight leading-none">
            Notificaciones
          </h1>
        </div>

        <div className="bg-[var(--kr-surface)] border border-[#FF3B3B]/10 rounded-2xl overflow-hidden">
          {loading ? (
            ...
            <div className="py-20 px-6 flex flex-col items-center text-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-[var(--kr-surface-sunken)] border border-[#FF3B3B]/15 flex items-center justify-center">
                <Bell size={22} className="text-[#FF3B3B]/50" />
              </div>
              <div>
                <p className="text-[var(--kr-text)] font-black text-lg mb-1">Nada por acá todavía</p>
              ...
              <Link
                to="/profile"
                className="mt-1 flex items-center gap-2 px-5 py-2.5 bg-[#FF3B3B] text-[var(--kr-text)] font-black text-[11px] uppercase tracking-widest rounded-xl hover:bg-[#FF6B6B] transition-colors"
              >

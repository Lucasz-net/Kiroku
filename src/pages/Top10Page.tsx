    ...
    <div className="min-h-screen bg-[#080A0F] font-sans">
      <div className="container mx-auto px-4 md:px-8 pt-32 md:pt-36 pb-24 max-w-[1100px]">
        ...
        <div className="flex items-center gap-4 mb-10 flex-wrap">
          <div className="w-14 h-14 rounded-xl overflow-hidden bg-[#11131A] border border-[#FF3B3B]/20 flex items-center justify-center text-xl font-black text-white shrink-0">
            {profile.avatar_url
          ...
          {isOwner && !isLocked && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 bg-[#0D0F15] border border-[#FF3B3B]/20 hover:border-[#FF3B3B]/50 text-zinc-400 hover:text-[#FF3B3B] font-black text-[11px] uppercase tracking-widest rounded-xl transition-colors shrink-0"
            >
        ...
        {isLocked ? (
          <div className="bg-[#11131A] border border-[#FF3B3B]/10 rounded-2xl px-8 py-16 flex flex-col items-center text-center gap-4">
          ...
          <div className="bg-[#11131A] border border-[#FF3B3B]/10 rounded-2xl p-6 md:p-10 relative overflow-hidden">
                ...
                <div className="mt-12 flex flex-col gap-2.5">
                  {rest.map(entry => (
                    <Link
                      ...
                      className="group flex items-center gap-4 bg-[#0D0F15] border border-[#FF3B3B]/[0.08] hover:border-[#FF3B3B]/40 rounded-xl p-2.5 pr-4 transition-colors"
                    >
                      ...
                      />
                      <span className="flex-1 min-w-0 text-sm font-bold text-white group-hover:text-[#FF7777] transition-colors line-clamp-2">
                        {entry.title}
                      </span>
                    </Link>
                  ))}

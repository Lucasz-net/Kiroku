...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="min-h-screen bg-[var(--kr-bg)] flex items-center justify-center px-4 font-sans">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-[var(--kr-text)] font-black text-xl mb-2">Algo salió mal</h1>
          <p className="text-zinc-500 text-sm mb-8">
            Ocurrió un error inesperado. Recargá la página para seguir usando Kiroku.
          </p>
          <button
            onClick={() => window.location.reload()}
            className="inline-flex items-center gap-2 bg-[#FF3B3B] text-[var(--kr-text)] font-black px-6 py-3 rounded-xl hover:bg-[#e02d2d] transition-all text-sm uppercase tracking-widest"
          >

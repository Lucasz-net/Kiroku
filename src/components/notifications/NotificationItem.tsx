  ...
  return (
    ...
    >
      ...
      <div className="relative shrink-0">
        <div className="w-9 h-9 rounded-lg bg-[#0D0F15] border border-[#FF3B3B]/10 overflow-hidden flex items-center justify-center font-black text-white text-xs">
        ...
        <span className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-[#11131A] border border-[#FF3B3B]/20 flex items-center justify-center ${meta.color}`}>
          <Icon size={9} />
        </span>
      </div>
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[13px] leading-snug text-zinc-300">
          <span className="font-black text-white">@{notification.actor_username}</span>{' '}
      ...
      {notification.subject_image && (
        <div className="w-8 h-11 shrink-0 rounded-md overflow-hidden bg-[#0D0F15] border border-[#FF3B3B]/10">
